    ...
    <div className="flex-1">
      ...
      <div className="bg-white border border-gray-200 rounded-md p-3 mb-5 flex justify-between items-center">
        <div className="text-gray-800">
          <span>12,911</span> items in <span className="font-semibold">Mobile accessory</span>
        </div>
        
        <div className="flex items-center space-x-4">
             <div className="flex items-center space-x-2">
                 <input type="checkbox" className="rounded border-gray-300 accent-blue-600 h-4 w-4 cursor-pointer" defaultChecked />
             ...
             <div className="flex border border-gray-300 rounded overflow-hidden">
                 <button 
                    className={`p-2 ${view === 'grid' ? 'bg-gray-200' : 'bg-white'} text-black hover:bg-gray-100`}
                    onClick={() => setView('grid')}
                 >
                     <BsGridFill />
                 </button>
                 <button 
                    className={`p-2 ${view === 'list' ? 'bg-gray-200' : 'bg-white'} text-black border-l border-gray-300`}
       ...
       <div className="flex flex-wrap items-center gap-2 mb-4">
          {activeFilters.map((filter, index) => (
              <div key={index} className="flex items-center border border-blue-500 rounded px-3 py-1 bg-white">
      ...
      <div className={`${view === 'grid' ? 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4' : ''}`}>
       ...
       <div className="flex justify-end items-center mt-5 space-x-2">
           ...
           <div className="flex border border-gray-300 rounded bg-white">
               ...
               <button className="px-3 py-1 border-r border-gray-300 text-gray-500 font-medium bg-gray-100">1</button>
               <button className="px-3 py-1 border-r border-gray-300 text-black hover:bg-gray-100">2</button>
               <button className="px-3 py-1 border-r border-gray-300 text-black hover:bg-gray-100">3</button>
