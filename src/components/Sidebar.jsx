...
const Sidebar = ({ toggleFilter, activeFilters = [] }) => {
  ...
  const StarRating = ({ rating }) => {
    return (
      <div className="flex text-orange-400 text-sm">
        {[...Array(5)].map((_, i) => (
          <IoIosStar key={i} className={i < rating ? "text-orange-500" : "text-gray-300"} />
        ))}
      </div>
    );
  };
  ...
  return (
    <div className="w-[230px] flex-shrink-0 hidden lg:block pr-4">
        {/* Category */}
      <div className="border-t border-gray-200 py-2">
        ...
        >
          ...
          {sections.category ? <MdKeyboardArrowUp className="text-gray-500" /> : <MdKeyboardArrowDown className="text-gray-500" />}
        </div>
        {sections.category && (
            ...
            <li className="text-blue-500 text-sm mt-2 hover:underline">See all</li>
            </ul>
        )}
      </div>
      ...
      <div className="border-t border-gray-200 py-2">
        ...
        >
          ...
          {sections.brands ? <MdKeyboardArrowUp className="text-gray-500" /> : <MdKeyboardArrowDown className="text-gray-500" />}
        </div>
        {sections.brands && (
            ...
            <li className="text-blue-500 text-sm mt-2 hover:underline cursor-pointer">See all</li>
            </ul>
        )}
      </div>
      ...
      <div className="border-t border-gray-200 py-2">
        ...
        >
          ...
          {sections.features ? <MdKeyboardArrowUp className="text-gray-500" /> : <MdKeyboardArrowDown className="text-gray-500" />}
        </div>
        {sections.features && (
            <ul className="space-y-2">
      ...
      <div className="border-t border-gray-200 py-2">
         ...
         >
          ...
          {sections.priceRange ? <MdKeyboardArrowUp className="text-gray-500" /> : <MdKeyboardArrowDown className="text-gray-500" />}
        </div>
        {sections.priceRange && (
            <>
      ...
      <div className="border-t border-gray-200 py-2">
        ...
        >
          ...
          {sections.condition ? <MdKeyboardArrowUp className="text-gray-500" /> : <MdKeyboardArrowDown className="text-gray-500" />}
        </div>
        {sections.condition && (
            <ul className="space-y-2">
                {["Any", "Refurbished", "Brand new", "Old items"].map((item, i) => (
                    <li key={i} className="flex items-center space-x-2">
                        ...
                        />
                        <span className={`${selectedCondition === item ? 'text-black' : 'text-gray-600'}`}>{item}</span>
                    </li>
                ))}
            </ul>
        )}
      ...
      <div className="border-t border-gray-200 py-2">
        ...
        >
          ...
          {sections.ratings ? <MdKeyboardArrowUp className="text-gray-500" /> : <MdKeyboardArrowDown className="text-gray-500" />}
        </div>
        {sections.ratings && (
            <ul className="space-y-2">
                {[5, 4, 3, 2].map((r, i) => (
                    <li key={i} className="flex items-center space-x-2 cursor-pointer">
                        <input 
                            type="checkbox" 
                            className="rounded border-gray-300 accent-blue-600 h-4 w-4 cursor-pointer" 
       ...
       <div className="border-t border-gray-200 py-4">
        ...
        >
          <h3 className="font-semibold">Manufacturer</h3>
           {sections.manufacturer ? <MdKeyboardArrowUp className="text-gray-500" /> : <MdKeyboardArrowDown className="text-gray-500" />}
        </div>
